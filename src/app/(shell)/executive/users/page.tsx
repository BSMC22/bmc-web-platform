...
import InviteUserForm from "@/components/executive/invite-user-form";
import UserRoleForm from "@/components/executive/user-role-form";
import { createClient } from "@/lib/supabase/server";
import type { AdminUser } from "@/lib/supabase/types";

export const metadata: Metadata = {
  title: "Usuarios — Executive Center — Blueseas OS",
